...
class asa:
    ...
    def setar_secoes_intermediarias(self):
        self.coef_inter_corda = Modelo.calcula_interpolador(
            self.envs, self.cordas, Modelo.grau_interpolacao_corda
        )
        self.coef_inter_offset = Modelo.calcula_interpolador(
            self.envs, self.offsets, Modelo.grau_interpolacao_offset
        )
        (
            self.inter_corda,
            self.inter_offset,
            self.inter_envs,
            self.inter_num_p,
        ) = Modelo.calcula_secoes(
            self.wingspan,
            self.coef_inter_corda,
            Modelo.grau_interpolacao_corda,
            self.coef_inter_offset,
            Modelo.grau_interpolacao_offset,
            self.envs,
            self.cordas,
            self.offsets,
        )
